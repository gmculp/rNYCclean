...
build_rNYCclean_data <- function(pad_version,snd_version,this.dir,my.cores,as_rdb=TRUE) {
	...
	if(as_rdb) {
		...
		save(borocode_words_vector, file = file.path(this.dir, "borocode_words_vector.rda"))
		zipcode_words_vector <- objs[["zipcode_words_vector"]]
		save(zipcode_words_vector, file = file.path(this.dir, "zipcode_words_vector.rda"))
